...
OPS = {
    ...
    'nor_conv_1x1': lambda C_in, C_out, stride, affine, track_running_stats: ReLUConvBN(C_in, C_out, (1, 1),
                                                                                        ...
                                                                                        (1, 1), affine,
                                                                                        track_running_stats),
    'sep_conv_3x3': lambda C_in, C_out, stride, affine, track_running_stats: DualSepConv(C_in, C_out, (3, 3),
                                                                                         (stride, stride), (1, 1),
                                                                                         (1, 1), affine,
                                                                                         track_running_stats),
    'sep_conv_5x5': lambda C_in, C_out, stride, affine, track_running_stats: DualSepConv(C_in, C_out, (5, 5),
                                                                                         (stride, stride), (2, 2),
                                                                                         (1, 1), affine,
                                                                                         track_running_stats),
    'dil_conv_3x3': lambda C_in, C_out, stride, affine, track_running_stats: SepConv(C_in, C_out, (3, 3),
                                                                                     (stride, stride), (2, 2), (2, 2),
                                                                                     affine, track_running_stats),
    'dil_conv_5x5': lambda C_in, C_out, stride, affine, track_running_stats: SepConv(C_in, C_out, (5, 5),
...
NAS_BENCH_101 = ['none', 'skip_connect', 'nor_conv_1x1', 'nor_conv_3x3', 'max_pool_3x3']
DARTS_SPACE = ['none', 'skip_connect', 'sep_conv_3x3', 'sep_conv_5x5', 'dil_conv_3x3', 'dil_conv_5x5', 'avg_pool_3x3',
               'max_pool_3x3']

SearchSpaceNames = {'nas-bench-201': NAS_BENCH_201,
                    'nas-bench-101': NAS_BENCH_101,
                    'darts': DARTS_SPACE}
...
class NasBenchDownsample(nn.Module):

    def __init__(self, inplanes, planes):
        super(NasBenchDownsample, self).__init__()
        self.downsample = nn.Sequential(
