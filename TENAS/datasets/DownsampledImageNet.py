...
def check_integrity(fpath, md5=None):
    ...
    if md5 is None:
        ...
        # print('it is md5 something, thingy')
...
if __name__ == '__main__':
    train = ImageNet16('/scratch/sem21f14/Data/ImageNet16/downsampled_imagenet16x16', True, None)
    valid = ImageNet16('/scratch/sem21f14/Data/ImageNet16/downsampled_imagenet16x16', False, None)

    print(len(train))
    print(len(valid))
    image, label = train[111]
    trainX = ImageNet16('/scratch/sem21f14/Data/ImageNet16/downsampled_imagenet16x16', True, None, 200)
    validX = ImageNet16('/scratch/sem21f14/Data/ImageNet16/downsampled_imagenet16x16', False, None, 200)
    print(len(trainX))
    print(len(validX))
